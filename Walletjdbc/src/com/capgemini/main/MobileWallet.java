...
public class MobileWallet {
	...
	static WalletRepoInterface walletRepo = new WalletRepoImpl();
	static WalletService walletService = new WalletServiceImp(walletRepo);
	
	public static void main(String[] args) throws InsufficientBalanceException, DupicateMobileNumberException, MobilenumberIsNotFoundException, ClassNotFoundException {
	...
	private static void getDetails() throws DupicateMobileNumberException, ClassNotFoundException {
